...
import {ScrollView, TextInput, TouchableOpacity, ImageBackground, Text, View, Alert, ToastAndroid} from 'react-native';
    ...
    if (current_date > subs_date) {
        ...
        return (
            <View style={{flex: 1, justifyContent: "center", alignItems: "center",}}>
                <Text style={{fontWeight: 'bold', fontSize: 15, textAlign: 'center', color: 'darkblue'}}>You do not have
                    paid account to see the content.</Text>
            ...
            RNFetchBlob.fetch('POST', 'https://leedsng.com/api/atc_trigger_email.php', {
                ...
                .then((res) => {
                    ...
                    if (jsonData['success'] == 1) {
                        ToastAndroid.show('Message Sent', 1200);
                        setTimeout(() => {
